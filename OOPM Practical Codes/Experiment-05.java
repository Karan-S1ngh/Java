...
class ComplexNumber {
    public static void main(String args[]) {
        ...
        System.out.println("First Number is: " + r1 + (i1 >= 0 ? " + " : " - ") + Math.abs(i1) + "i");
        System.out.println("Second Number is: " + r2 + (i2 >= 0 ? " + " : " - ") + Math.abs(i2) + "i");
        System.out.println("Sum is: " + r3 + (i3 >= 0 ? " + " : " - ") + Math.abs(i3) + "i");
    }
}
