/*
Q4
Through Custom exception user can raise application-specific error code. 
Write a JAVA program to calculate a square of even number provided as input by user. 
However, if a user provides an odd number as input, 
then an exception must be thrown explicitly with message indicating the input number must be even number
(Experiment 10)
*/
